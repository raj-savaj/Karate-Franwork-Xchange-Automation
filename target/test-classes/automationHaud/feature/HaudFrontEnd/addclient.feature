...
Scenario: Validate Add Client
    ...
    And input('#root > div.MainLayout.MainLayout--MenuBar > div.MainLayoutContent > main > div > div:nth-child(2) > div > div.k-card-body > div > div:nth-child(2) > span > label','Client 2')
    And eval sleep(2000)
    ...
    #And input('#root > div.MainLayout.MainLayout--MenuBar > div.MainLayoutContent > main > div > div:nth-child(2) > div > div.k-card-body > div > div:nth-child(14) > span > span > span > span.k-searchbar > input','EUR')
    And click('#root > div.MainLayout.MainLayout--MenuBar > div.MainLayoutContent > main > div > div:nth-child(2) > div > div.k-card-body > div > div:nth-child(14) > span > span > span > span.k-select > span')
    And click('body > div.k-animation-container.k-animation-container-relative.k-list-container.k-reset > div > div > ul :nth-child(2)')
    And click('#root > div.MainLayout.MainLayout--MenuBar > div.MainLayoutContent > main > div > div:nth-child(2) > div > div.k-card-body > div > div:nth-child(10) > span > span')
